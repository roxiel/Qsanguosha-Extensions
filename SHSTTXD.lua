...
sgs.LoadTranslationTable{
	...
	["yinyu"]="饮羽",	
	["yinyu_heart"]="饮羽·射",
	[":yinyu_heart"]="当你的【饮羽】判定结果为红桃时,此技能生效,你的<b><font color='red'>攻击范围</font></b>无限",	
	[":yinyu"]="—回合开始阶段,你可以进行一次判定,获得与判定结果对应的一项技能直到回合结束：\
	♥~攻击范围无限\
	♦~使用的【杀】不可被闪避\
	♠~可使用任意数量的【杀】\
	♣~无视其他角色的防具",
	["#yinyu_diamond"]="%from的【饮羽】被触发,目标不可闪避此【杀】",
	["#yinyu_club"]="%from的【饮羽】被触发,无视该角色防具",
	["#yinyu_heart"]="你的锦囊并不是无限距离的",
	...
	["yuehe"]="乐和",
	["yueli"]="乐理",
	[":yueli"]="若你的判定牌为基本牌,在其生效后,你可以立即获得之",
	["#yueli"]="%from 的技能【<b><font color='red'>乐理</font></b>】被触发,他悄悄拿走了判定牌",
	["taohui"]="韬晦",
	[":taohui"]="回合结束阶段,你可以进行一次判定:若结果不为基本牌,你可以令任一角色摸一张牌,并可以再次使用“韬晦”——如此反复,直到出现基本牌为止",
	["#taohui"]="由于%from  的【<b><font color='red'>韬晦</font></b>】,%arg被深深地陶冶了情操",
	["~yuehe"]="叫子也难吹奏了",
	["$yueli1"]="呵呵……",
	["$yueli2"]="且慢,音律有误",	
	["$taohui1"]="白云起,郁披香离复合,曲未央",
	["$taohui2"]="此曲只应天上有,人间能得几回闻",

	["muhong"]="穆弘",
	["wuzu"]="无阻",
	[":wuzu"]="<b>锁定技</b>,你始终无视其他角色的防具",
	["#wuzu"]="%from 的锁定技【<b><font color='yellow'>无阻</font></b>】被触发,无视了其他角色的防具",	
	["huqi"]="虎骑",
	...
	["#qiangqu"]="%from 硬是跟%arg入了洞房",
	["huatianai"]="花田·爱",
	[":huatianai"]="你每受到1点伤害,可以令任一已受伤的其他角色回复1点体力",
	["huatiancuo"]="花田·错",
	[":huatiancuo"]="你每回复1点体力,可以对任一其他角色造成1点伤害",
	["#huatianai"]="%from 与%arg 仿佛置身于一片花田之中",
	["#huatiancuo"]="%arg 嘤咛一声倒在了花田中,看样子是中了情毒",
	["$qiangqu1"]="小娘子,春宵一刻值千金啊!",
	["$qiangqu2"]="今夜,本大王定要做新郎!",
	["$huatianai1"]="千年玉骨掩尘沙,空有余妍剩此花",
	["$huatianai2"]="无妨,只当为汝披嫁纱",
	["~zhoutong"]="虽有霸王相,奈无霸王功啊!",
	
	["chaijin"]="柴进",
	["danshu"]="丹书",
	[":danshu"]="<b>锁定技</b>,当其他角色使用【杀】指定你为目标时,须额外弃置X张手牌,X为你已损失的体力值否则该【杀】对你无效",
	["haoshen"]="豪绅",
	[":haoshen"]="你可以跳过你的摸牌阶段,令任一其他角色将手牌补至其体力上限的张数\
你可以跳过你的出牌阶段,将一半的手牌（向上取整）交给任一其他角色", 
	["haoshen_vs"]="豪绅·2",
	[":haoshen_vs"]="当你使用豪绅跳过出牌阶段时,此技能生效",
	["#danshu"]="%from 的锁定技【<b><font color='yellow'>丹书</font></b>】被触发,%arg  必须再额外弃牌才能使【杀】生效",
	["#danshunodiscard"]="%from 的【杀】对 %arg 无效",
	["#haoshendraw"]="%from 跳过了<b><font color='blue'> 摸牌 </font></b>阶段,可以选择一名其他角色将手牌补至其体力上限的张数",
	["#haoshenplay"]="%from 跳过了<b><font color='blue'> 出牌 </font></b>阶段,可以将一半的手牌（向上取整）交给一名其他角色",	
...
若结果均为黑色,你对其造成2点雷电伤害",
	...
	["#huanshufire"] = "%arg 受到%from 【幻术】的影响,仿佛置身火海",
	["#huanshuthunder"] = "%arg 受到%from 【幻术】的影响,仿佛被雷劈了",
	["#huanshufailed"] = "%from 发动了半天幻术,却只放出了一个屁",
	["#mozhang"] = "%from 的锁定技【魔障】被触发,其武将牌将被横置",
	["$huanshu1"]="沙石一起,真假莫辨!",
	["$huanshu2"]="五行幻化,破!",
	...
	["andaoquan"]="安道全",
	["shsjishi"] = "济世",
	[":shsjishi"] = "任意角色的回合开始时,若该角色已受伤,你可以弃置一张手牌,令其回复1点体力每回合限一次",
	["yanshou"] = "延寿",
	[":yanshou"] = "<b>限定技</b>,出牌阶段,你可以弃置两张红桃牌,令任一角色增加1点体力上限",
	["fengyue"] = "风月",
	[":fengyue"] = "回合结束阶段,你可以摸X张牌,X为场上存活的女性角色数且至多为2每回合限一次",
	["$yanshou"] = "助你延寿十年!",
	...
	["cuju"]="蹴鞠",
	[":cuju"]="每当你受到伤害时,可以进行一次判定:\
若结果为黑色,你可以弃置一张手牌,将该伤害转移给任一其他角色",
	["panquan"]="攀权",
	[":panquan"]="<b>主公技</b>,其他官势力角色每回复1点体力,可以让你摸两张牌,然后你将一张手牌置于牌堆顶",
	["#hengxing"]="%from的【横行】被触发,将额外摸%arg张牌",
	["#hengxingdeath"]="%arg this",
	["#cuju"]="%from 将伤害踢给了%arg",
	["#cujufailed"]="%from 蹴鞠虽好却射不出来",
	["#panquan"]="%arg 同意发动<b><font color='blue'>攀权</font><b>让%from摸2张牌",
	["@panquan"]="请选择一张手牌,这张牌将被置于牌堆顶",
	["panquan:agree"]="让高俅摸两张牌",
	["panquan:ignore"]="忽略攀权",
...
★失去装备区牌的角色将获得原判定牌",
	["qimen"]="奇门",
	[":qimen"]="任意角色的回合开始时,你可以令任一角色进行一次判定,\
若你弃置一张与该判定牌相同花色的手牌,则该角色不能发动当前的所有技能直到回合结束",
	["@qimen"]="请打出一张牌用于奇门",	 
	["#qimen"]="%from 的<b><font color='blue'>【奇门】</font><b>生效,%arg所有武将技能本回合内无效",	
	["#qimenend"]="%arg 被<b><font color='blue'>【奇门】</font><b>封印的状态结束",
	["$yixing1"]="天命有旋转,地星而应之",
	["$yixing2"]="夜道极阴,昼道极阳",
	["$qimen1"]="汝逢大凶,不宜出兵再战!",
	["$qimen2"]="小奇改门户,大奇变格局",
	...
	["lujunyi"]="卢俊义",
	["baoguo"]="报国",
	[":baoguo"]="每当其他角色受到伤害时,你可以弃置一张牌,将此伤害转移给你;\
你每受到一次伤害,可以摸X张牌,X为你已损失的体力值.",	
	["#baoguo"]="%from 的技能<b><font color='green'>【报国】</font><b>被触发,将摸取%arg张手牌",
	["#baoguodamage"]="%from 将替 %arg 承受%arg2点伤害",
	["$baoguo1"]="大丈夫为国尽忠,死而无憾!",
	["$baoguo2"]="与其坐享金山,不如为国杀敌!",
...
2.弃掉该角色的一张牌",
	["hongjin:draw"]="摸一张牌",
	["hongjin:discard"]="弃置目标角色一张牌",
	["hongjin:draw"]="摸一张牌",
	["#hongjindiscard"]="%from 使用了技能<b><font color='red'>【红锦】</font><b>,将弃置%arg一张牌",
	["#hongjindraw"]="%from 使用了技能<b><font color='red'>【红锦】</font><b>,将摸一张牌",
	["wuji"]="武姬",
	...
	["songjiang"]="宋江",
	["ganlin"]="甘霖",
	[":ganlin"]="出牌阶段,你可以将任意数量的手牌以任意分配方式交给其他角色\
若如此做,你可以选择将手牌补至X张,X为你已损失的体力值\
发牌之后若你无手牌将自动补牌\
补牌之后,本技能将不能再次使用",
	["ganlincard"]="甘霖",
	["ganlincard:draw"]="补充手牌至你已损失的体力值",
	["ganlincard:no"]="这次不补充手牌",
	["juyi"]="聚义",
	[":juyi"]="<b>主公技</b>,其他寇势力角色可在他们各自的出牌阶段与你交换一次手牌（你可以拒绝）",
	["#ganlin"]="%from使用了技能<b><font color='yellow'>【甘霖】</font><b>",
	["#ganlindraw"]="<b><font color='yellow'>【甘霖】</font><b>的额外效果被触发,%from将摸取%arg张牌",
	["#juyi"]="%from使用了技能<b><font color='yellow'>【聚义】</font><b>,将与%arg交换所有手牌",
	["#juyino"]="%arg 拒绝了%from【聚义】的请求",
	["#juyidebug"]="%from this time!",
	["juyiother"]="聚义换牌",
	[":juyiother"]="出牌阶段,你可以与主公宋江交换所有手牌,每回合限一次",
	["juyicard"]="聚义换牌",
	["juyicard:yes"]="接受交换所有手牌",
	["juyicard:no"]="拒绝",	
	["$ganlin1"]="扶危济困,急人所难",
